...
import { logo, id, passwordsvg } from "../../assets";
import { Link } from "react-router-dom";
import axios from "axios";
import { useNavigate } from "react-router-dom";
import validator from "validator";

const validateLoginForm = (idnumber, password) => {
...
function LoginS() {
  ...
  const handleLogin = async (event) => {
    ...
    const validationErrors = validateLoginForm(idnumber, password);
    ...
    try {
      ...
      setMessage(`ID number or password are incorrect`);
      setTimeout(() => {
        setMessage("");
        setIdnumber("");
        setPassword("");
  ...
  return (
    <div>
      <Header heading="Signin to create an account" />
        ...
        <div className="flex flex-wrap justify-center items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              {message && (
                <div className="flex justify-center text-sky-600 font-thin-100 p-4 mb-4 font-bold">
                  {message}
                </div>
              )}
